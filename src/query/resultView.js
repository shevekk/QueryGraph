...
QueryGraph.Query.ResultView = class ResultView
{
  ...
  static RESULT_GRAPH_BUTTON_ID = "resultGraphButton";
  ...
  displayResults(graph, data, selectVars, listEdgesLabel)
  {
    ...
    {
      content += `<button class="${QueryGraph.Query.ResultView.RESULT_BUTTON_CLASS}" id="${QueryGraph.Query.ResultView.RESULT_GRAPH_BUTTON_ID}">${QueryGraph.Dictionary.Dictionary.get("RESULTS_GRAPH_BUTTON")}</button>`;
    }
    ...
    $("#" + QueryGraph.Query.ResultView.RESULT_GRAPH_BUTTON_ID).click(function()
    {
      me.openExternalView("resultGraph/index.php", graph, data, selectVars, listEdgesLabel);
    });
  }
