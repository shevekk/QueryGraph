 ...
 */
QueryGraph.Query.DataCollectorPersee = class DataCollectorPersee extends QueryGraph.Query.DataCollector 
{
  /**
  ...
  getNodesData(name, callback)
  {
    ...
    /*
      ...
      WHERE {
        ...
        OPTIONAL { ?work dcterms:abstract ?description }
    ...
    me.launchQuery(queryURL, function(data)
    {
      ...
      */
      query = `PREFIX rdagroup2elements: <http://rdvocab.info/ElementsGr2/>
        ...
        WHERE {
         ?person foaf:name ?name . 
          OPTIONAL { ?person rdfs:label ?note }
